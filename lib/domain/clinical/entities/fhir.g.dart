...
_$_Attester _$$_AttesterFromJson(Map<String, dynamic> json) => _$_Attester(
      id: json['ID'] == null
          ? null
...
Map<String, dynamic> _$$_AttesterToJson(_$_Attester instance) =>
    <String, dynamic>{
...
_$_RelatesTo _$$_RelatesToFromJson(Map<String, dynamic> json) => _$_RelatesTo(
      id: json['ID'] == null
          ? null
          : CodeableConcept.fromJson(json['ID'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$_RelatesToToJson(_$_RelatesTo instance) =>
    <String, dynamic>{
      'ID': instance.id?.toJson(),
      'Code': instance.code,
...
_$_Age _$$_AgeFromJson(Map<String, dynamic> json) => _$_Age(
      ...
      comparator:
          $enumDecodeNullable(_$ComparatorEnumEnumMap, json['Comparator']),
...
_$_Composition _$$_CompositionFromJson(Map<String, dynamic> json) =>
    _$_Composition(
      ...
      status:
          $enumDecodeNullable(_$CompositionStatusEnumEnumMap, json['Status']),
      type: json['Type'] == null
          ? null
...
_$_TimingRepeat _$$_TimingRepeatFromJson(Map<String, dynamic> json) =>
    _$_TimingRepeat(
      ...
      when: $enumDecodeNullable(_$TimingRepeatPeriodUnitEnumMap, json['When']),
...
_$_Timing _$$_TimingFromJson(Map<String, dynamic> json) => _$_Timing(
      ...
      code: $enumDecodeNullable(_$TimingCodesEnumMap, json['Code']),
    );
...
_$_RateRatio _$$_RateRatioFromJson(Map<String, dynamic> json) => _$_RateRatio(
      id: json['ID'] as String?,
...
Map<String, dynamic> _$$_RateRatioToJson(_$_RateRatio instance) =>
    <String, dynamic>{
      'ID': instance.id,
