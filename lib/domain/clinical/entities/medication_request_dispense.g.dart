...
_$_MedicationRequestDispense _$_$_MedicationRequestDispenseFromJson(
    Map<String, dynamic> json) {
  return _$_MedicationRequestDispense(
...
Map<String, dynamic> _$_$_MedicationRequestDispenseToJson(
