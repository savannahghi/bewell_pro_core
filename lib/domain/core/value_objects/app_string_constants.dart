...
final String bewellCopyrightString =
    'Copyright ©️ ${returnCurrentYear()} Slade360° Advantage';
...
const String emailSubtitle =
    'Receive emails, including verification PINs and communication from Slade360° Advantage';
const String emailTitle = 'Email';
const String messagesSubTitle =
    'Receive text messages including, verification PINs and communication from Slade360° Advantage';
const String messagesTitle = 'Text messages';
const String pageHeader = 'Updates from Slade360° Advantage';
const String pushSubTitle =
    'Receive push notifications including, verification PINs and communication from Slade360° Advantage';
...
const String faqTitle = 'Slade360° Advantage support center';
